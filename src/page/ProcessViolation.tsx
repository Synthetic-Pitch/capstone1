            ...
            <section className="max-w-300 w-full py-12 px-4 flex flex-col">
                <section className="font-family-poppins w-full py-4 px-4 flex flex-col desktop:flex-row justify-center gap-6">
                    ...
                    {file1 && file2 && (
                        <button
                            onClick={onSubmit}
                            className="text-2xl bg-[#0b318f] max-w-min m-auto px-32 tablet:px-42 py-4 text-white rounded-2xl mt-12 cursor-pointer hover:scale-[1.05] transition-all duration-100"
                        >
                            submit
                        </button>
                    )}
