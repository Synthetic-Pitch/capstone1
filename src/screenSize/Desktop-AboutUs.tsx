        ...
        <div className="hidden tablet:flex flex-col items-center  relative">
            <section className="h-dvh max-h-220 w-full relative bg-linear-to-b from-[#d7d2d3] to-[#a0a0a0] overflow-hidden">
                <main className="w-full h-full max-w-300  flex flex-col items-center justify-center m-auto">
                    <p ref={headingRef} className="text-[#052751] tablet:text-[3rem] desktop:text-[4rem] font-family-mozilla text-center pb-20 z-5 font-bold space-x-1">
                    OPSS MARIKINA CITY
                    </p>
                    <div className="grid desktop:grid-cols-2 relative">
                        ...
                        <div className="px-8 tablet:pt-6" ref={missionRef}>
